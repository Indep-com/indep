    ...
    create(context) {
        return {
            CallExpression: (node) => {
                ...
                const isWindowOpen = (0, index_js_1.isIdentifier)(property, 'open') &&
                    ((0, index_js_1.isIdentifier)(object, 'window') || isThisWindow(object));
                if (!isWindowOpen) {
                    return;
                }
...
function isThisWindow(node) {
    return (node.type === 'MemberExpression' &&
        ...
        (0, index_js_1.isIdentifier)(node.property, 'window'));
}
...
function extractString(context, node) {
    const literalNodeOrNothing = (0, index_js_1.getValueOfExpression)(context, node, 'Literal');
    if (literalNodeOrNothing === undefined || !(0, index_js_1.isStringLiteral)(literalNodeOrNothing)) {
        return undefined;
    }
    else {
