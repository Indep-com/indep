...
function decorate(rule) {
    return (0, index_js_1.interceptReportForReact)({
        ...rule,
    ...
    function getMainNodeLocation(node, context) {
        ...
        if (index_js_1.functionLike.has(node.type)) {
            const fun = node;
            const ctx = context;
            return (0, index_js_1.getMainFunctionTokenLocation)(fun, fun.parent, ctx);
        }
        /* should not happen */
        return node.loc;
    }
