...
const noUnmodifiedLoopEslint = index_js_1.eslintRules['no-unmodified-loop-condition'];
exports.rule = {
    ...
    create(context) {
        ...
        const ruleDecoration = (0, index_js_2.interceptReport)(noUnmodifiedLoopEslint, function (context, descriptor) {
            ...
            if ((0, index_js_2.isUndefined)(node) || (symbol && alreadyRaisedSymbols.has(symbol))) {
                return;
            }
...
class LoopVisitor {
    ...
    visit(root, context) {
        const visitNode = (node, isNestedLoop = false) => {
            ...
            (0, index_js_2.childrenOf)(node, context.sourceCode.visitorKeys).forEach(child => visitNode(child, isNestedLoop));
        };
        visitNode(root);
    }
}
