...
exports.rule = void 0;
const index_js_1 = require("../typescript-eslint/index.js");
...
const switchWithoutDefaultRule = {
    ...
    create(context) {
        ...
        const hasTypeInformation = (0, index_js_2.isRequiredParserServices)(services);
        return {
            SwitchStatement(node) {
                const { discriminant, cases } = node;
                if (hasTypeInformation && (0, index_js_2.isUnion)(discriminant, services)) {
                    return;
                }
 ...
 */
const switchExhaustivenessRule = index_js_1.tsEslintRules['switch-exhaustiveness-check'];
const decoratedSwitchExhaustivenessRule = (0, index_js_2.interceptReport)(switchExhaustivenessRule, function (context, descriptor) {
...
exports.rule = {
    meta: (0, index_js_2.generateMeta)(meta_js_1.meta, {
        hasSuggestions: true,
        messages: {
    ...
    create(context) {
        return (0, index_js_2.mergeRules)(switchWithoutDefaultRule.create(context), decoratedSwitchExhaustivenessRule.create(context));
    },
};
