 ...
 */
const noUselessEscapeRule = index_js_1.eslintRules['no-useless-escape'];
const noNonoctalDecimalEscapeRule = index_js_1.eslintRules['no-nonoctal-decimal-escape'];
/**
...
exports.rule = {
    ...
    create(context) {
        ...
        return (0, index_js_2.mergeRules)(noUselessEscapeListener, decoratedNoNonoctalDecimalEscapeListener);
    },
};
function decorateNoNonoctalDecimalEscape(rule) {
    return (0, index_js_2.interceptReport)(rule, (context, descriptor) => {
