...
const baseRuleModule = index_js_1.tsEslintRules['no-magic-numbers'];
exports.rule = {
    meta: (0, index_js_2.generateMeta)(meta_js_1.meta, baseRuleModule.meta),
    create(context) {
...
function getNumericLiteral(node) {
    ...
    let parent = (0, index_js_2.getNodeParent)(node);
    if (!parent || !value) {
        return undefined;
    }
    ...
    if (parent.type === 'UnaryExpression' && parent.operator === '-') {
        numberNode = parent;
        parent = (0, index_js_2.getNodeParent)(parent);
        value = -value;
        raw = `-${node.raw}`;
    }
    else {
...
function isJsonStringify(node) {
    return node.type === 'CallExpression' && (0, index_js_2.isMethodInvocation)(node, 'JSON', 'stringify', 3);
}
