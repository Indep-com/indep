...
function isStringLike(node) {
    return (0, index_js_1.isStringLiteral)(node) || isStringConcatenation(node);
}
function isStringConcatenation(node) {
    return (0, index_js_1.isBinaryPlus)(node) && (isStringLike(node.left) || isStringLike(node.right));
}
