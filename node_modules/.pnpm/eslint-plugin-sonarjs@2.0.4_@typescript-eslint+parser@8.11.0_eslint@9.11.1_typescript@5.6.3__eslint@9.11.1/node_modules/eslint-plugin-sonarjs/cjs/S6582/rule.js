 ...
 */
const preferOptionalChainRule = index_js_1.tsEslintRules['prefer-optional-chain'];
/**
 ...
 */
exports.rule = {
    meta: (0, index_js_2.generateMeta)(meta_js_1.meta, { ...preferOptionalChainRule.meta }),
    create(context) {
