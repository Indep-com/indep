...
const constructorSuperRule = index_js_1.eslintRules['constructor-super'];
const noThisBeforeSuperRule = index_js_1.eslintRules['no-this-before-super'];
exports.rule = {
    ...
    create(context) {
        ...
        return (0, index_js_2.mergeRules)(constructorSuperListener, notThisBeforeSuperListener);
    },
};
