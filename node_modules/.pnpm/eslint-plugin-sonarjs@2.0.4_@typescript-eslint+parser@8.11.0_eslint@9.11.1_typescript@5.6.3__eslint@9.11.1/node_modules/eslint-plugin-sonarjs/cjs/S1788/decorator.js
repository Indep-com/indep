...
function decorate(rule) {
    return (0, index_js_1.interceptReport)({
        ...rule,
        meta: (0, index_js_1.generateMeta)(meta_js_1.meta, rule.meta),
...
function reportExempting(exemptionCondition) {
    return (context, reportDescriptor) => {
        if ('node' in reportDescriptor) {
            ...
            const variable = scope.variables.find(value => (0, index_js_1.isIdentifier)(node.left, value.name));
...
function isReduxReducer(enclosingFunction) {
    if (enclosingFunction.params.length === NUM_ARGS_REDUX_REDUCER) {
        ...
        return (firstParam.type === 'AssignmentPattern' &&
            (0, index_js_1.isIdentifier)(firstParam.left, 'state') &&
            (0, index_js_1.isIdentifier)(secondParam, 'action'));
    }
    return false;
}
